...
namespace Assets.Scripts.LiplisSystem.Web.Clalis.v60
{
    public class ClalisForLiplisGetNewTopicOne
    {
        ...
        /// <returns></returns>
        public static ResLpsTopicList GetNewTopic(List<string> toneUrlList)
        {
            try
            {
                ...
                //パラメータ生成
                ps.Add("reqmsg", json); //トーンURL

                //Jsonで結果取得
                string jsonText = HttpPost.sendPostAndDecompressUtf8(LpsDefine.LIPLIS_API_NEW_TOPIC_ONE_MLT, ps);
