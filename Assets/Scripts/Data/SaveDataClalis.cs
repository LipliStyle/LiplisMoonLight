...
{
    public class SaveDataClalis
    {
        /// <summary>
        /// SingletonなSaveDatabaseクラス
        /// </summary>
        protected static SaveDataSystemBin data = null;

        protected static SaveDataSystemBin Savedatabase
        {
            get
            {
                if (data == null)
                {
                    ...
                    data = new SaveDataSystemBin(path, fileName);
                }
                return data;
            }
        }
