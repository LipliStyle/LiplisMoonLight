...
namespace Assets.Scripts.Data.SubData
{
    ...
    public class DatNewTopic
    {
        ...
        /// <summary>
        /// 全データのBaseNewsDataリストを取得する
        /// </summary>
        /// <returns></returns>
        public List<MsgBaseNewsData> GetTopic2BaseNewsDataAllList()
        {
            List<MsgBaseNewsData> ResList = new List<MsgBaseNewsData>();

            foreach (var item in TalkTopicList)
            {
                ResList.Add(item.Convert2BaseNewsData());
            }
