...
{
    public class CharDataHazuki : CharDataBase
    {
        ///=============================
        /// 設定プロパティ

        //アロケーションID
        public int ALLOCATION_ID = 0;

        //葉月 Y座標
        //public const float CARACTER_LOCATION_Y = -2.0f;
        public const float CARACTER_LOCATION_Y = -93;


        //葉月デフォルト位置
        public MST_CARACTER_POSITION DEFAULT_POSITION = MST_CARACTER_POSITION.Moderator;
        ...
        {
            return base.CreateCharData(LIVE2D_CANVAS.L2DC_Hazuki_F, LIVE2D_CANVAS.L2DC_Hazuki_R, LIVE2D_CANVAS.L2DC_Hazuki_L, ALLOCATION_ID ,DEFAULT_POSITION, PREFAB_NAMES.WINDOW_TALK_S_1, CARACTER_LOCATION_Y);
        }
        ...
        protected override CharDataGreet CreateCharDataGreet(CharDataTone Tone, int allocationID)
        {
            ...
            //グリーとデータ生成
            Greet.AddGreetData(new MsgGreet(Tone, DateUtil.CreateDatetime(6, 0, 0), DateUtil.CreateDatetime(10, 0, 0), "おはようございます、ご主人様。", EMOTION.JOY, 3, allocationID));
            Greet.AddGreetData(new MsgGreet(Tone, DateUtil.CreateDatetime(6, 0, 0), DateUtil.CreateDatetime(10, 0, 0), "おはようございます、ご主人様。", EMOTION.NORMAL, 0, allocationID));
