...
namespace Assets.Scripts.Data
{
    public class LiplisModels
    {
        ...
        /// シングルトンインスタンス
        /// </summary>
        private static LiplisModels instance;
        public static LiplisModels Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new LiplisModels();
                }
        ...
        private void LoadModel()
        {
            ...
            //フォルダリスト取得
            List<string> LstModelOnTheStage = CreateModelPathList();
