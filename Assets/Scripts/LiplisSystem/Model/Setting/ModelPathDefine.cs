//====================================================================
//  ClassName : Live2dModelPathDefine
//  概要      : Liplisモデル Live2d パス設定定義
//              
//
//  LiplisMoonlight
...
namespace Assets.Scripts.LiplisSystem.Model.Setting
{
    /// <summary>
    /// Live2dファイルパス定義
    /// </summary>
    public class ModelPathDefine
    {
        ///=============================
        ///設定パス定義
        public const string LIPLIS_MODEL_JSON   = "/LiplisModel.json";
        public const string LIPLIS_MODELS_JSON  = "/LiplisModels.json";
