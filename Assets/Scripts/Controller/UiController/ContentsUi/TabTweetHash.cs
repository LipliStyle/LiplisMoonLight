...
{
    public class TabTweetHash : TabBaseTopicList
    {
        ///=============================
        ///プロパティ
        ...
        {
            this.Clear();
            this.Categoly = ContentCategoly.hotHash;
            base.Start();
        }
        #endregion
        ...
        public IEnumerator UpdateNewsList()
        {
            ...
            if (LiplisStatus.Instance.NewsList.LastNewsList.HashList == null)
            {
                yield break;
            }

            StartCoroutine(UpdateContent(this.Content, LiplisStatus.Instance.NewsList.LastNewsList.HashList));
