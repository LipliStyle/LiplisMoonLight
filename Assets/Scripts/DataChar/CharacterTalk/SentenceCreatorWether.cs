//====================================================================
//  ClassName : SentenceCreatorWether
//  概要      : 天気文章を生成するクラス
//              
//
//  LiplisLive2D
...
{
    public class SentenceCreatorWether
    {
        //====================================================================
        // 
        //                           天気情報関連
        ...
        /// </summary>
        /// <returns></returns>
        public static void SetWetherSentence(List<MsgSentence> q, CharDataTone Tone, int AllocationId)
        {
            //NULLチェック
        ...
        /// </summary>
        /// <returns></returns>
        public static void CreateWetherMessage(string dayString, MsgDayWether result, List<MsgSentence> q, CharDataTone Tone, int AllocationId)
        {
            //全入力
        ...
        /// </summary>
        /// <returns></returns>
        private static void CreateWetherMessage3(string dayString, MsgDayWether result, List<MsgSentence> q, CharDataTone Tone, int AllocationId)
        {
            //	同一
        ...
        /// <returns></returns>
        private static MsgSentence CreateWetherSentence(string message, string wetherCode, bool addMessage, CharDataTone Tone,int AllocationId)
        {
            //エモーションをセットする
        ...
        /// </summary>
        /// <returns></returns>
        private static void CreateWetherMessage2(string dayString, MsgDayWether result, List<MsgSentence> q, CharDataTone Tone, int AllocationId)
        {
            //同じ
        ...
        /// </summary>
        /// <returns></returns>
        private static void CreateWetherMessage1(string dayString, MsgDayWether result, List<MsgSentence> q, CharDataTone Tone, int AllocationId)
        {
